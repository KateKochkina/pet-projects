...
void printError(const MyType *exact, const MyType *x, int n,
                MyType normVector(const MyType *const, const int));
...
#define useNormInf  // иначе норма 1
#ifdef useNormInf
...
void printResidual(const MyType *const *const A, const MyType *const b, const MyType *const x, const int n,
                   MyType normVector(const MyType *const, const int))  // Подсчет нормы невязки
{
...
void printError(const MyType *const exact, const MyType *const x, const int n,
                MyType normVector(const MyType *const, const int))  // Подсчет нормы ошибки
{
